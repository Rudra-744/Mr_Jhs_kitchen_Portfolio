...
const Home = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center px-6 overflow-hidden pt-28 md:pt-0 bg-[#FDFBF7]"
    >
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(#800000 1.5px, transparent 1.5px)",
      ...
      <div className="max-w-7xl mx-auto w-full flex flex-col-reverse lg:grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10 pb-12 lg:pb-0">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white border border-jha-maroon/10 px-4 py-2 rounded-full shadow-sm mb-2 mx-auto lg:mx-0">
            ...
            <span className="text-jha-maroon font-bold text-xs uppercase tracking-widest">
              Shivalik Platinum, Ahmedabad
            </span>
          </div>
          ...
          <p className="text-lg text-gray-600 max-w-lg mx-auto lg:mx-0 leading-relaxed font-medium">
            Your cozy corner for authentic{" "}
            <span className="text-jha-maroon font-bold">
              Laphing, Ramen & Momos.
            </span>
            Come for the food, stay for the vibe!
            <span className="block mt-3 text-sm font-bold bg-yellow-100 text-yellow-800 inline-block px-3 py-1 rounded-lg">
              🐶 Pet Friendly Cafe
            </span>
          </p>
          ...
          <div className="pt-8 flex gap-8 justify-center lg:justify-start border-t border-gray-200/40 mt-6 opacity-80">
            <div>
              <h4 className="text-2xl font-bold text-jha-maroon">4.8★</h4>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">
                On Google
              </p>
            </div>
            <div>
              <h4 className="text-2xl font-bold text-jha-maroon">100%</h4>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">
                Fresh Food
              </p>
            </div>
            <div>
              <h4 className="text-2xl font-bold text-jha-maroon">15yr</h4>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">
                Legacy
              </p>
            </div>
        ...
        >
          ...
          >
            <span className="text-2xl md:text-4xl bg-yellow-100 p-2 rounded-xl">
              🥣
            </span>
            <div>
              ...
              <h4 className="text-sm md:text-lg font-bold text-jha-maroon">
                Laphing
              </h4>
            </div>
          </motion.div>
          ...
          >
            <span className="text-2xl md:text-4xl bg-red-100 p-2 rounded-xl">
              🍜
            </span>
            <div>
              <p className="text-[10px] font-bold text-gray-400 uppercase">
          ...
          >
            ...
            <span className="text-xs md:text-sm font-bold text-jha-maroon">
              Crispy Sides
            </span>
          </motion.div>
        </motion.div>
